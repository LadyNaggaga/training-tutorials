...
In this lesson, we will cover how to load non-primitive types from the database, how to chain commands to include multiple layers of related data, and how to use explicit loading and aggregate functions.
